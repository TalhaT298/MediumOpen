...
const BanglaGPT = () => {
    return (
        ...
        <div className="flex items-center justify-center  bg-black text-center text-white">
            <div>
                <h1 className="text-3xl md:text-5xl font-semibold mb-4" style={{ fontFamily: "Atma, sans-serif", fontWeight: 600 }}>
                    Writes, brainstorms, edits,<br /> and explores ideas with বাংলাGPT
                </h1>
